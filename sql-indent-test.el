...
(ert-deftest sqlind-ert-prXX-postgres ()
  (sqlind-ert-check-file-syntax "test-data/prxx-postgres.sql" "test-data/prxx-postgres-syn.eld"))

(ert-deftest sqlind-ert-prXX-oracle ()
  (sqlind-ert-check-file-syntax "test-data/prxx-oracle.sql" "test-data/prxx-oracle-syn.eld"))
